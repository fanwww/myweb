...
>
> ![image-20210412191035956](./ts_qs/image-20210412191035956.png)
>
>2. 解决
>
> ```tsx
...
>2. 出现错误原因分析:![image-20210422115014706](./ts_qs/1.png)
>
>​	![image-20210422115208905](./ts_qs/2.png)
>
>3. 解决
>
> 4. 其实不用`_d`去取出来,Moment格式有相应的取出方法
>
>    ![image-20210422115825841](./ts_qs/image-20210422115825841.png)
